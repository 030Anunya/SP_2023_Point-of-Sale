...
<div class="modal fade" id="modalcategory" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="categoryForm-create" action="{{ route('categorys.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="category_name" name="category_name"
                                    placeholder="โปรดระบุหมวดหมู่สินค้า" />
                            </div>
                        </div>
                    </div>
            ...
            <form class="form-horizontal d-none" id="categoryForm-update" action="{{ route('categorys.update', 45) }}" method="POST">
                <div class="modal-body">
                    <div id="create-category">
                        @csrf
                        @method('PUT')
